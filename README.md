...
Each lab contains multiple folders, each folder is a specific programming exercise. Within each folder is a program called main and a Makefile. The program is the template for the exercise and the Makefile is the required file using make to compile/link/load it to an UNO. 
